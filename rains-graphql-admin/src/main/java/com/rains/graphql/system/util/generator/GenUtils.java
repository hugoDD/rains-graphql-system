...
public class GenUtils {
     ...
     * 初始化表信息
     */
    public static void initTable(GenTable genTable, String operName, GeneratorConfig genConfig) {
        genTable.setClassName(convertClassName(genTable.getTableName(), genConfig));
        genTable.setPackageName(genConfig.getBasePackage());
        genTable.setModuleName(getModuleName(genConfig.getBasePackage()));
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        if (arraysContains(GenConstants.COLUMNTYPE_STR, dataType)) {
            ...
            column.setGraphqlType(GenConstants.TYPE_STRING);
        } else if (arraysContains(GenConstants.COLUMNTYPE_TIME, dataType)) {
            column.setJavaType(GenConstants.TYPE_DATE);
            column.setGraphqlType(GenConstants.TYPE_DATE);
     ...
     * @return 类名
     */
    public static String convertClassName(String tableName, GeneratorConfig genConfig) {
        boolean autoRemovePre = "1".equals(genConfig.getIsTrim());
        String tablePrefix = genConfig.getTrimValue();//.getTablePrefix();
