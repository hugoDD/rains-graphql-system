...
//            }
    ...
    @Override
    public void saveLog(ProceedingJoinPoint point, LogVo log) throws JsonProcessingException {
        Log dest = new Log();
        BeanUtils.copyProperties(log,dest);
        this.saveLog(point,dest);
    }
}
