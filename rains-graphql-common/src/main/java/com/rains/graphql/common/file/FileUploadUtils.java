package com.rains.graphql.common.file;


import com.rains.graphql.common.exception.file.FileSizeLimitExceededException;
import com.rains.graphql.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
    ...
    private static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = RainsGraphqlProperties.getProfile().length() + 1;
