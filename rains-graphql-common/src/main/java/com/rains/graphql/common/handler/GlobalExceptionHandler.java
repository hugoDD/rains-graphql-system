...
public class GlobalExceptionHandler {
    ...
    public ResultResponse handleException(Exception e) {
        ...
        return new ResultResponse().message("系统内部异常");
    }

    @ExceptionHandler(value = SysException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResultResponse handleParamsInvalidException(SysException e) {
        log.error("系统错误：{}", e.getMessage());
        return new ResultResponse().message(e.getMessage());
    }
    ...
    public ResultResponse validExceptionHandler(BindException e) {
        ...
        return new ResultResponse().message(message.toString());
